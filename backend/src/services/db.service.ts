...
function seedInitialData() {
  ...
  if (userCount.count === 0) {
    ...
    `).run(
      ...
      '2001-03-14',
      'female',
      'May your journey ahead shimmer with effortless joy, boundless wonder, and all the magic you bring into every room you step into. You deserve the world and more. Happy Birthday! ✨',
      'en',
      'rose',
      'trk_1',
      'generated',
