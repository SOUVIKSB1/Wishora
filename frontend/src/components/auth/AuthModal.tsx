...
import { Sparkles, Mail, Lock, User, Cake, Crown, ArrowRight, ArrowLeft, ShieldCheck, Camera, Upload, Check, AlertCircle, Film, Heart, Music, Flame, Loader2 } from 'lucide-react';
...
export const AuthModal: React.FC<AuthModalProps> = ({ onSuccess, onPreviewDemo }) => {
          ...
          <div className="space-y-6 text-center">
            ...
            <div className="space-y-3 pt-2">
              ...
              >
                ...
                <span>{googleLoading ? 'Connecting to Google Securely...' : 'Continue with Google'}</span>
              </button>
              ...
              {/* First Interaction Live Experience Preview */}
              {onPreviewDemo && (
                <button
                  type="button"
                  onClick={onPreviewDemo}
                  className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-2xl bg-white/[0.05] hover:bg-white/[0.1] border border-white/[0.12] text-amber-300 font-mono text-xs font-bold transition-all cursor-pointer"
                >
                  <span>🎬 Experience Live Wish Preview</span>
                </button>
              )}
            </div>
