...
import { Folder as FolderIcon, Sparkles, Clock, Video, Eye, Plus, Trash2, ExternalLink, Play, Pause, MessageSquare, X, ArrowLeft, Mic, Share2, Heart, Check, Edit3, ChevronDown, CheckCircle2, Layers } from 'lucide-react';
...
export const WishbookView: React.FC<WishbookViewProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'all' | 'folders' | 'drafts' | 'vault'>('all');
        ...
        {[
          ...
          <button
            ...
            onClick={() => {
              ...
              if (tab.key !== 'all') setSelectedFolderId(null);
            }}
                  ...
                  <div key={group.recipient} className={isStack ? 'col-span-1 space-y-3' : 'col-span-1'}>
                    ...
                    {displayItems.map((w, idx) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between border-t border-white/[0.1] pt-3.5 mt-1">
